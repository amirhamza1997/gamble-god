...
export default function Home() {
  return (
    <main className="bg-violet-900 min-h-screen xl:p-10 lg:p-11 md:p-6 max-[440px]:p-6 max-[320px]:p-2">
      ...
      <div className="xl:mt-28 lg:mt-16 md:mt-20 min-[425px]:mt-24 min-[375px]:mt-24 min-[320px]:mt-24 flex items-center justify-center text-[color:white] ">
      ...
      <div className='flex sm:justify-end xl:mt-36 lg:mt-16 md:mt-24 min-[425px]:mt-24 min-[375px]:mt-24 min-[320px]:mt-24 xl:mt-28 max-[375px]: justify-center'>
        <Image
          src={'/images/gamble-god-logo.png'}
          alt='Gamblegod Logo'
          width={150}
